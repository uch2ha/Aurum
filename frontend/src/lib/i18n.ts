...
const ru = {
  ...
  'auth.noAuthModalBody':
    'Этот экземпляр Aurum не защищён паролем — все данные доступны любому, кто до него достучится. Задайте AURUM_BASIC_AUTH_USER и AURUM_BASIC_AUTH_PASSWORD в .env, чтобы включить вход.',
  ...
  'dashboard.noExpensesThisMonth':
    'За этот месяц пока нет расходов. Добавьте первую транзакцию на вкладке «Транзакции».',
  ...
  'crypto.search.noApiKey':
    'Не настроен ключ CoinGecko API — задайте AURUM_COINGECKO_API_KEY в .env (бесплатный ключ на coingecko.com/en/api/pricing).',
  ...
  'roi.calculator.hint':
    'Впишите стоимость и ожидаемый доход в месяц, чтобы увидеть годовую доходность, срок окупаемости и прогноз на годы вперёд.',
  'roi.calculator.projectionTitle': 'Прогноз со сложным процентом',
  'roi.calculator.projectionHint':
    'Если доходность {{percent}}% в год сохранится и весь доход будет реинвестироваться обратно в ту же инвестицию — расчёт только на основе введённых вами цифр, без данных из ваших активов.',
  ...
  'transactions.import.uploadHint':
    'Выгрузка транзакций из банка или другого приложения в формате CSV (с заголовками колонок в первой строке).',
  ...
  'transactions.import.categoryHint':
    'Если текст в колонке точно совпадёт с названием существующей категории — она подставится автоматически.',
  ...
  'transactions.import.encodingHint':
    'Определяется автоматически; если вместо русских букв — кракозябры, попробуйте выбрать вручную.',
  ...
  'transactions.import.duplicateCheckFailed':
    'Не удалось проверить, есть ли уже такие транзакции на счёте — при импорте возможны дубли.',
  'transactions.import.duplicatesFound':
    'Найдено похожих на уже существующие: {{count}}. По умолчанию они не импортируются.',
  ...
  'transactions.import.presetHint':
    'Готовые профили: Т-Банк, monobank, ПриватБанк — колонки и форматы подставятся сами. Выгрузки других банков импортируются через ручное сопоставление колонок.',
  'transactions.import.presetDetected':
    'Профиль банка: {{bank}}. Колонки и форматы подставлены автоматически — проверьте и при необходимости поправьте.',
  'transactions.import.presetNotDetected':
    'Формат банка не распознан — сопоставьте колонки вручную или выберите банк из списка.',
  ...
  'transactions.form.splitHint':
    'Одна покупка — несколько категорий, например часть чека — продукты, часть — бытовая химия.',
  ...
  'transactions.form.splitNoChildren':
    'У этой категории пока нет подкатегорий — добавьте их на странице «Категории», чтобы разбивать покупки по ним.',
  ...
  'backup.footerWarning': 'Восстановление полностью заменяет текущие данные содержимым файла — это нельзя отменить.',
  ...
  'insights.riskyAllocationExceeded':
    'Рискованная часть капитала — {{percent}}%, превышает установленный лимит {{threshold}}%',
  'insights.idleCashOne':
    'На 1 счёте лежит крупная сумма без движения {{days}}+ дней — возможно, эти деньги стоит куда-то вложить',
  'insights.idleCash':
    'На {{count}} счетах лежит крупная сумма без движения {{days}}+ дней — возможно, эти деньги стоит куда-то вложить',
  ...
  'category.defaultDeleteBlocked':
    'Стандартную категорию можно удалить только после того, как у неё не останется транзакций.',
...
const en: Record<keyof typeof ru, string> = {
  ...
  'auth.sessionOnlyHint':
    'You stay signed in until you close the browser. Staying signed in for longer needs HTTPS or localhost.',
  ...
  'auth.noAuthModalBody':
    'This Aurum instance has no password protection — all data is accessible to anyone who can reach it. Set AURUM_BASIC_AUTH_USER and AURUM_BASIC_AUTH_PASSWORD in .env to enable login.',
  ...
  'crypto.search.noApiKey':
    'CoinGecko API key not configured — set AURUM_COINGECKO_API_KEY in .env (free key at coingecko.com/en/api/pricing).',
  ...
  'roi.calculator.hint':
    'Enter the price and expected monthly income to see the annual return, payback period, and a multi-year projection.',
  'roi.calculator.projectionTitle': 'Compound interest projection',
  'roi.calculator.projectionHint':
    'If the {{percent}}% annual return holds and all income is reinvested back into the same investment — based only on the numbers you entered, not your tracked assets.',
  ...
  'transactions.import.uploadHint':
    'A transaction export from your bank or another app, in CSV format (with column headers in the first row).',
  ...
  'transactions.import.categoryHint':
    "If the column's text exactly matches an existing category name, it's filled in automatically.",
  ...
  'transactions.import.encodingHint':
    'Auto-detected; if you see garbled characters instead of letters, try picking one manually.',
  ...
  'transactions.import.duplicateCheckFailed':
    "Couldn't check what's already on this account — importing may create duplicates.",
  'transactions.import.duplicatesFound':
    "Found {{count}} that look like duplicates of existing transactions. They're left out by default.",
  ...
  'transactions.import.presetHint':
    'Built-in profiles: T-Bank, monobank, PrivatBank — columns and formats are pre-filled. Exports from other banks go through manual column mapping.',
  'transactions.import.presetDetected':
    'Bank profile: {{bank}}. Columns and formats were pre-filled — review and adjust if needed.',
  'transactions.import.presetNotDetected':
    'Bank format not recognised — map the columns by hand or pick a bank from the list.',
  ...
  'transactions.form.splitHint':
    'One purchase, several categories — e.g. part of a receipt is groceries, part is household chemicals.',
  ...
  'transactions.form.splitNoChildren':
    'This category has no subcategories yet — add some on the Categories page to split purchases across them.',
  ...
  'insights.negativeCashFlow':
    'Expenses have exceeded income for {{months}} months in a row (based on the last completed months)',
  ...
  'insights.idleCashOne':
    '1 account is holding a large balance with no activity for {{days}}+ days — that money might be worth putting to work',
  'insights.idleCash':
    '{{count}} accounts are holding a large balance with no activity for {{days}}+ days — that money might be worth putting to work',
